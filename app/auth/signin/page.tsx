...
function SignInForm() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 to-background-light p-4">
            <div className="w-full max-w-md">
                {/* Logo */}
                <div className="text-center mb-8">
                    <Link href="/" className="inline-block">
                        <Image
                            src="/Zintel Logo High Quility.png"
                            alt="Zintel"
                            width={180}
                            height={60}
                ...
                <div className="card bg-white shadow-lg">
                    {registered && (
                        <div className="p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3 mb-5">
